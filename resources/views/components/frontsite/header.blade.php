...
<nav x-data="{ navbarMobileOpen: false }" class="bg-white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex flex-auto justify-between">
                ...
                <a
                    ...
                    after:w-8/12 after:-translate-x-1/2 after:bottom-3 after:left-1/2 font-semibold inline-flex 
                    items-center px-1 text-lg" 
                ...
                <div class="-mr-2 flex items-center lg:hidden">
                    <button
                        ...
                        class="inline-flex items-center justify-center p-2 rounded-md
                         ...
                         focus:ring-2 focus:ring-inset focus:ring-[#0D63F3]"
                        aria-controls="mobile-menu"
                        aria-expanded="false"
                        @click="navbarMobileOpen = ! navbarMobileOpen"
                    >
    ...
    <div class="lg:hidden" id="mobile-menu" x-show="navbarMobileOpen">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a
            href="#"
            class="bg-indigo-50 border-[#0D63F5] text-[#1E2B4F] 
            block pl-3 pr-4 py-2 border-l-4 text-base font-semibold"
            >Home</a
            >
            <a
            href="#"
            class="border-transparent text-[#1E2B4F]
